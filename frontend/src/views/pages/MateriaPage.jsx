              ...
              {(subject.temario || []).map((tema) => (
                <div key={tema.title} className="glass-effect-light p-4 rounded-xl flex flex-col gap-3">
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    ...
                    {tema.description ? <p className="text-sm text-slate-500 dark:text-slate-400 w-full">{tema.description}</p> : null}
                    <div className="flex gap-2">
                      <button onClick={() => openExternalSearch('google', `${tema.title} ${subject.title}`)} className="p-2 rounded-full hover:bg-slate-100 dark:hover:bg-white/10 text-slate-400 hover:text-[#4285F4] transition-colors" title="Buscar en Google">
                      ...
                      <button onClick={() => openExternalSearch('youtube', `${tema.title} ${subject.title} tutorial`)} className="p-2 rounded-full hover:bg-slate-100 dark:hover:bg-white/10 text-slate-400 hover:text-[#FF0000] transition-colors" title="Ver en YouTube">
                      ...
                      <button onClick={() => openExternalSearch('chatgpt', `Explica el tema ${tema.title} de ${subject.title} para estudiantes de ingeniería con ejemplos.`)} className="p-2 rounded-full hover:bg-slate-100 dark:hover:bg-white/10 text-slate-400 hover:text-[#00A67E] transition-colors" title="Consultar AI (Perplexity)">
